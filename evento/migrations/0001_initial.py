...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Lugar'
        db.create_table(u'evento_lugar', (
        ...
        db.send_create_signal(u'evento', ['Lugar'])

        # Adding model 'Evento'
        db.create_table(u'evento_evento', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ...
            ('lugar', self.gf('django.db.models.fields.related.ForeignKey')(related_name='eventos', to=orm['evento.Lugar'])),
        ))
        db.send_create_signal(u'evento', ['Evento'])

        # Adding model 'Ponencia'
        db.create_table(u'evento_ponencia', (
        ...
        db.send_create_signal(u'evento', ['Ponencia'])

        # Adding M2M table for field articulos on 'Ponencia'
        m2m_table_name = db.shorten_name(u'evento_ponencia_articulos')
        ...
        # Adding model 'Charla'
        db.create_table(u'evento_charla', (
            (u'evento_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['evento.Evento'], unique=True, primary_key=True)),
        ...
        db.send_create_signal(u'evento', ['Charla'])
        ...
        db.create_table(u'evento_apertura', (
            (u'evento_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['evento.Evento'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'evento', ['Apertura'])

        # Adding model 'Clausura'
        db.create_table(u'evento_clausura', (
            (u'evento_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['evento.Evento'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'evento', ['Clausura'])


    def backwards(self, orm):
        # Deleting model 'Lugar'
        db.delete_table(u'evento_lugar')

        # Deleting model 'Evento'
        db.delete_table(u'evento_evento')

        # Deleting model 'Ponencia'
        db.delete_table(u'evento_ponencia')

        # Removing M2M table for field articulos on 'Ponencia'
        db.delete_table(db.shorten_name(u'evento_ponencia_articulos'))

        # Deleting model 'Charla'
        db.delete_table(u'evento_charla')

        # Deleting model 'Social'
        db.delete_table(u'evento_social')

        # Deleting model 'Apertura'
        db.delete_table(u'evento_apertura')

        # Deleting model 'Clausura'
        db.delete_table(u'evento_clausura')
    ...
    models = {
        ...
        u'evento.evento': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lugar': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'eventos'", 'to': u"orm['evento.Lugar']"}),
        ...
        u'evento.social': {
            'Meta': {'object_name': 'Social', '_ormbases': [u'evento.Evento']},
            u'evento_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['evento.Evento']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'modulo_clei.clei': {
