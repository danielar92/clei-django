...
from modulo_clei.views import CLEICreateView, CLEIListView, CLEIUpdateView, CLEIDetailView, TopicoCreateView, TopicoListView, TopicoUpdateView, ArticuloCreateView, ArticuloListView, ArticuloUpdateView
admin.autodiscover()
