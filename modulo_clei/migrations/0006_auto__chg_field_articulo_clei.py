...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Articulo.clei'
        db.alter_column(u'modulo_clei_articulo', 'clei_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['modulo_clei.CLEI']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Articulo.clei'
        raise RuntimeError("Cannot reverse this migration. 'Articulo.clei' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Articulo.clei'
        db.alter_column(u'modulo_clei_articulo', 'clei_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modulo_clei.CLEI']))
