...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Persona.dirPostal'
        db.add_column(u'personas_persona', 'dirPostal',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60),
                      keep_default=False)

        # Adding field 'Persona.pagWeb'
        db.add_column(u'personas_persona', 'pagWeb',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=60),
                      keep_default=False)

        # Adding field 'Persona.telf'
        db.add_column(u'personas_persona', 'telf',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Persona.dirPostal'
        db.delete_column(u'personas_persona', 'dirPostal')

        # Deleting field 'Persona.pagWeb'
        db.delete_column(u'personas_persona', 'pagWeb')

        # Deleting field 'Persona.telf'
        db.delete_column(u'personas_persona', 'telf')
